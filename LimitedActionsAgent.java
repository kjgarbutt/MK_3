...
public final class LimitedActionsAgent implements Steppable	{
	 ...
	 */
    public LimitedActionsAgent(MK_3 g, String homeTract, String workTract,
    ...
    public LimitedActionsAgent(MK_3 g, int homeTract, int workTract,
			GeomPlanarGraphEdge startingEdge, GeomPlanarGraphEdge goalEdge) {
	}
   ...
   public void step(SimState state)	{
       ...
       boolean toWork3 = ((MK_3) state).goToWork3;
